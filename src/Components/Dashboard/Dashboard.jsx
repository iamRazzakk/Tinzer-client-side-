                ...
                <ul className="menu md:p-6  md:text-xl">
                    ...
                    {currentUser?.role === "Admin" &&
                        <>
                            ...
                            <li className="md:mb-4"><NavLink to='/dashboard/history'>Appointment History</NavLink></li>
                    ...
                    {currentUser?.role === "user" &&
                        <>
                            ...
                            <li className="md:mb-4"><NavLink to='/dashboard/my-appointment'>My Appointment</NavLink></li>
