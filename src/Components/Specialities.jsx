        ...
        <div className="lg:p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="lg:mt-10">
                    <a  className="flex flex-col items-center bg-white border border-primary rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-secondary dark:bg-primary  dark:hover:bg-secondary">
