...
const CountUpCard = ({ startNumber, endNumber, prefix }) => {
    ...
    return (
        <div data-aos="fade-down" className=" lg:mb-10 bg-[#07092B]  p-4 rounded-lg shadow-md text-white text-center PatientDetails">
...
const CountUpSection = () => {
    return (
        <div>
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-6  mt-10">
